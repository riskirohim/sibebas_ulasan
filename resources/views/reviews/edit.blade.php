...
<head>
    ...
    <title>Edit Ulasan Barang</title>
    <!-- Bootstrap 5 CSS -->
    ...
    <div class="container py-4">
        <div class="card shadow-sm mx-auto" style="max-width: 600px;">
            <div class="card-body p-4">
                <h1 class="h4 card-title text-center mb-4 fw-bold">Edit Ulasan Barang</h1>
                <form action="{{ route('reviews.update', $review->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="star-rating d-flex justify-content-center mb-2" id="star-rating-container">
                            @for($i = 1; $i <= 5; $i++)
                                <i class="bi {{ $i <= $review->rating ? 'bi-star-fill' : 'bi-star' }}" data-value="{{ $i }}"></i>
                            @endfor
                        </div>
